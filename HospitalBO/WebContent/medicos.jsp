...
<%@ page import="edu.model.Medico, java.text.SimpleDateFormat"%>
	...
	<div class="container">
		<form action="./MedicoController" method="post">
			<div class="row">
				...
				<div class="col-sm-8">
					<input type="text" name="txtId" value="<%=medicoAtual.getId()%>" />
				</div>
			</div>
			...
			<div class="row">
				...
				<div class="col-sm-8">
					<input type="text" name="txtCRM" value="<%=medicoAtual.getCrm()%>" />
				</div>
			</div>
